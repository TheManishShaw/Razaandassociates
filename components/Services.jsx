...
const Features = () => {
  return (
    ...
    <section className="pt-10 px-10 pb-8 lg:pt-[120px] lg:pb-[70px]">
        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 md:w-1/2 lg:w-1/4">
            <div className="wow fadeInUp group mb-12 bg-white" data-wow-delay=".1s">
              <div
                className="relative z-10 mb-8 flex h-[70px] w-[70px] items-center text-center justify-center rounded-2xl bg-orange-400"
              >
                <span
                  className="absolute top-0 left-0 z-[-1] mb-8 flex h-[70px] w-[70px] rotate-[25deg] items-center justify-center rounded-2xl bg-orange-400 bg-opacity-30 duration-300 group-hover:rotate-45"
                ></span>
                <svg
                  width="35"
                  height="35"
          ...
          <div className="w-full px-4 md:w-1/2 lg:w-1/4">
            ...
            >
              <div
                className="relative z-10 mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl bg-orange-400"
              >
                <span
                  className="absolute top-0 left-0 z-[-1] mb-8 flex h-[70px] w-[70px] rotate-[25deg] items-center justify-center rounded-2xl bg-orange-400 bg-opacity-30 duration-300 group-hover:rotate-45"
                ></span>
